// --------------------------------
// <copyright file="ScoreFormatter.cs">
...
namespace RelativeStrengthCalculator.Api.MediaFormatters
{
    ...
    public class ScoreFormatter : MediaTypeFormatter
    {
        ...
        public override bool CanWriteType(Type type) => typeof(ScoreDto) == type;

        public override async Task WriteToStreamAsync(Type type, object value, Stream writeStream, HttpContent content, TransportContext transportContext)
        {
            var score = value as ScoreDto;
